...
#define SS_T_I1 (SS::Type::GetBasicType(BT_I1))
#define SS_T_U2 (SS::Type::GetBasicType(BT_U2))
#define SS_T_I2 (SS::Type::GetBasicType(BT_I2))
#define SS_T_U4 (SS::Type::GetBasicType(BT_U4))
#define SS_T_I4 (SS::Type::GetBasicType(BT_I4))
#define SS_T_U8 (SS::Type::GetBasicType(BT_U8))
#define SS_T_I8 (SS::Type::GetBasicType(BT_I8))
#define SS_T_F4 (SS::Type::GetBasicType(BT_FLOAT))
#define SS_T_F8 (SS::Type::GetBasicType(BT_DOUBLE))
